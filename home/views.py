...
def try1(req):
    return render(req,'home/try.html')

#def indexstock(req):
    #return render(req,'home/indexstock.html')

#def ticker(req):
    #return render(req,'home/ticker.html')

#def result(req):
    #return render(req,'home/result.html')

#def API_Down(req):
    #return render(req,'home/API_Down.html')

#def Invalid_Days_Format(req):
    #return render(req,'home/Invalid_Days_Format.html')

#def Invalid_Ticker(req):
    #return render(req,'home/Invalid_Ticker.html')

#def Negative_Days(req):
    #return render(req,'home/Negative_Days.html')

#def Overflow_days(req):
    #return render(req,'home/Overflow_days.html')
...
def indexstock(request):
    ...
    return render(request, 'home/indexstock.html', {
...
def ticker(request):
    ...
    return render(request, 'home/ticker.html', {
...
def predict(request, ticker_value, number_of_days):
    try:
        ...
        return render(request, 'home/API_Down.html', {})

    try:
        # number_of_days = request.POST.get('days')
        number_of_days = int(number_of_days)
    except:
        return render(request, 'home/Invalid_Days_Format.html', {})
    ...
    if ticker_value not in Valid_Ticker:
        return render(request, 'home/Invalid_Ticker.html', {})
    
    if number_of_days < 0:
        return render(request, 'home/Negative_Days.html', {})
    
    if number_of_days > 365:
        return render(request, 'home/Overflow_days.html', {})
    ...
    return render(request, "home/result.html", context={ 'plot_div': plot_div, 
