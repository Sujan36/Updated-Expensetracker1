...
urlpatterns = [
    ...
    path('index/try',views.try1,name = 'wanna'),
    path('index/indexstock',views.indexstock,name = 'indexstock'),
    path('ticker',views.ticker,name = 'ticker'),
    #path('result',views.result,name = 'result'),
    #path('api_down',views.API_Down,name = 'api_down'),
    #path('invalid_days',views.Invalid_Days_Format,name = 'invalid_days'),
    #path('invalid_ticker',views.Invalid_Ticker,name = 'invalid_ticker'),
    #path('negative_days',views.Negative_Days,name = 'negative_days'),
    #path('overflow_days',views.Overflow_days,name = 'overflow_days'),
